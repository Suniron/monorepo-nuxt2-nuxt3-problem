...
import ServerCardDetails from '~/components/assets/type/server/CardDetails.vue'
...
// Edit asset details
import ServerEditDetails from '~/components/assets/type/server/EditDetails.vue'
