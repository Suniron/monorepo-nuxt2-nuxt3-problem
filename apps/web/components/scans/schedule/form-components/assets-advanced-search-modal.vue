...
<template>
  <v-card>
    ...
    <v-card-text>
      ...
      <p v-if="selectedAssets.length === 0">
        No assets selected
      </p>
      <p v-else-if="selectedAssets.length === 1">
        1 asset selected
      </p>
      <p v-else>
    ...
    <v-card-actions>
      ...
      <v-btn
        ...
        @click="selectAssets"
      >
        Select<span v-if="selectedAssets.length === 0" /><span v-else-if="selectedAssets.length === 1"> asset</span><span v-else> {{ selectedAssets.length }} assets</span>
      </v-btn>
    </v-card-actions>
  </v-card>
</template>
