          ...
          <template #activator>
            ...
            <v-list-item-content>
              <v-list-item-title
                ...
                {{ item.project_name }}</v-list-item-title
              >
            </v-list-item-content>
            ...
            <v-list-item-icon class="mx-3">
              <v-btn icon :to="'/remediation-projects/' + item.project_id">
                <v-icon title="Go to the project's page">mdi-eye</v-icon></v-btn
              >
            </v-list-item-icon>
          </template>
          ...
          <v-list-item>
            ...
            <v-list-item-action>
              <v-list-item-action-text
                >Due date: {{ item.due_date }}</v-list-item-action-text
              >
            </v-list-item-action>
          </v-list-item>
        </v-list-group>
